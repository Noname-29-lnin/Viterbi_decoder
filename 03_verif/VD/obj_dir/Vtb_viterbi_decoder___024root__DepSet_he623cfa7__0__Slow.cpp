...
VL_ATTR_COLD void Vtb_viterbi_decoder___024root___eval_initial__TOP(Vtb_viterbi_decoder___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_viterbi_decoder___024root___eval_initial__TOP\n"); );
    // Init
    VlWide<6>/*191:0*/ __Vtemp_1;
    // Body
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x6f646572U;
    __Vtemp_1[2U] = 0x5f646563U;
    __Vtemp_1[3U] = 0x65726269U;
    __Vtemp_1[4U] = 0x5f766974U;
...
VL_ATTR_COLD void Vtb_viterbi_decoder___024root___eval_triggers__stl(Vtb_viterbi_decoder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_viterbi_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_viterbi_decoder___024root___eval_triggers__stl\n"); );
    // Body
